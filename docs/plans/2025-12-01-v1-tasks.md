# router-hosts v0.5.0 Implementation Tasks

**Date:** 2025-12-01
**Last Updated:** 2025-12-15
**Status:** v0.5.0 core features complete - All E2E tests passing
**Related:** [v0.5.0 Design Document](2025-12-01-router-hosts-v1-design.md)

> **Note:** Post-v0.5.0 enhancements tracked in GitHub Issues.
...
| Storage abstraction | ✅ Complete | PR #99, #104, #110, 2025-12-15 |
...
**Status:** v0.5.0 core complete. Remaining items are enhancements and polish.
...
| Task | Issue | Description |
|------|-------|-------------|
| Dynamic certificate reload | #98 | Reload TLS certs via SIGHUP |
...
| Task | Issue | Description |
|------|-------|-------------|
| GHCR cleanup validation | #88 | Verify pruning workflow |
...
### Client CLI Enhancements (Post-v0.5.0)
...
| Documentation updates | 2025-12-10 | PR #81 - Updated project status to reflect v0.5.0 complete |
| FileFormat enum | 2025-12-10 | PR #77 - Type-safe file format handling |
| RollbackResult improvements | 2025-12-10 | PR #68 - #[must_use] and PartialEq |
| GHCR image pruning | 2025-12-10 | PR #73 - Keep only last 3 builds |
| CHANGELOG for v0.1.0 | 2025-12-10 | PR #78 - Document breaking changes |
| Import chunk size docs | 2025-12-10 | PR #42 - Document design choices |
| Storage abstraction layer | 2025-12-14 | PRs #99, #104 - Extract Storage trait, integrate DuckDB |
| Shared backend test suite | 2025-12-15 | PR #110 - 42 tests for Storage trait compliance |
