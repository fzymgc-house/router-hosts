...
//! ## hosts
//!
//! Standard /etc/hosts format with optional aliases, comments, and tags.
//! Use for direct import into system hosts files.
//!
//! ```text
//! # Generated by router-hosts
//! # Last updated: 2025-12-01 20:45:32 UTC
//! # Entry count: 2
//!
//! 192.168.1.10    server.local srv web    # Main server [prod]
//! 192.168.1.20    nas.local    # NAS storage [homelab]
//! ```
//!
//! ## json (JSONL)
//!
//! Newline-delimited JSON with all entry fields including metadata.
//! Use for backup/restore, data migration, or programmatic processing.
//!
//! Each line is a complete JSON object:
//! ```json
//! {"id":"...","ip_address":"192.168.1.10","hostname":"server.local","aliases":["srv"],...}
//! ```
//!
//! ## csv
//!
...
//!
//! **Fields:** `ip_address,hostname,aliases,comment,tags`
//!
//! **Separator conventions:**
//! - Fields are comma-separated (standard CSV)
//! - Aliases are semicolon-separated within the aliases field (e.g., `srv;web;api`)
//! - Tags are semicolon-separated within the tags field (e.g., `prod;web`)
//!
//! **Escaping:** Fields containing commas, quotes, or newlines are quoted per RFC 4180.
//!
//! **Note:** Metadata fields (id, timestamps, version) are omitted for simplicity.
//! Use JSON format if you need complete entry data.
//!
//! ```csv
//! ip_address,hostname,aliases,comment,tags
//! 192.168.1.10,server.local,srv;web,Web server,prod;web
//! 192.168.1.20,nas.local,,"Storage, backup",homelab
//! ```
...
mod tests {
    ...
    #[test]
    fn test_invalid_export_format_display() {
        let err = InvalidExportFormat;
        assert_eq!(err.to_string(), "invalid export format");
    }

    #[test]
    fn test_export_error_display() {
        let err = ExportError("test error".to_string());
